...
ipcMain.handle("launcher:start-microsoft-login", () => launcher.startMicrosoftLogin());
ipcMain.handle("launcher:poll-microsoft-login", (_event, deviceCode: string) => launcher.pollMicrosoftLogin(deviceCode));
