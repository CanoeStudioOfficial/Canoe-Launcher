...
const messages = {
  "zh-CN": {
    ...
    "account.offlineProfile": "离线档案",
    "account.microsoftProfile": "Microsoft 档案",
    ...
    "microsoft.title": "Microsoft 登录",
    "microsoft.body": "使用设备码连接拥有 Minecraft: Java Edition 的 Microsoft 账号。",
    "microsoft.clientIdPlaceholder": "Azure 应用程序 Client ID 或环境变量",
    "microsoft.start": "开始 Microsoft 登录",
    "microsoft.check": "检查登录状态",
    "microsoft.userCode": "用户代码",
    "microsoft.copyCode": "复制代码",
    "microsoft.openPage": "打开 Microsoft 登录页",
    "microsoft.statusReady": "配置 Client ID 后即可开始设备码登录。",
    "microsoft.statusWaiting": "等待你在 Microsoft 页面完成授权。",
    "microsoft.statusSlowDown": "Microsoft 要求稍慢一点检查，我会自动延后轮询。",
    "microsoft.statusComplete": "Microsoft 账号已连接。",
    "microsoft.statusFailed": "Microsoft 登录未完成。",
    "status.remote": "未安装",
  ...
  "zh-TW": {
    ...
    "account.offlineProfile": "離線檔案",
    "account.microsoftProfile": "Microsoft 檔案",
    ...
    "microsoft.title": "Microsoft 登入",
    "microsoft.body": "使用裝置碼連接擁有 Minecraft: Java Edition 的 Microsoft 帳號。",
    "microsoft.clientIdPlaceholder": "Azure 應用程式 Client ID 或環境變數",
    "microsoft.start": "開始 Microsoft 登入",
    "microsoft.check": "檢查登入狀態",
    "microsoft.userCode": "使用者代碼",
    "microsoft.copyCode": "複製代碼",
    "microsoft.openPage": "開啟 Microsoft 登入頁",
    "microsoft.statusReady": "設定 Client ID 後即可開始裝置碼登入。",
    "microsoft.statusWaiting": "等待你在 Microsoft 頁面完成授權。",
    "microsoft.statusSlowDown": "Microsoft 要求稍慢一點檢查，我會自動延後輪詢。",
    "microsoft.statusComplete": "Microsoft 帳號已連接。",
    "microsoft.statusFailed": "Microsoft 登入未完成。",
    "status.remote": "未安裝",
  ...
  en: {
    ...
    "account.microsoftProfile": "Microsoft profile",
    ...
    "microsoft.title": "Microsoft sign-in",
    "microsoft.body": "Connect a Microsoft account that owns Minecraft: Java Edition with device code sign-in.",
    "microsoft.clientIdPlaceholder": "Azure application Client ID or environment variable",
    "microsoft.start": "Start Microsoft sign-in",
    "microsoft.check": "Check sign-in",
    "microsoft.userCode": "User code",
    "microsoft.copyCode": "Copy code",
    "microsoft.openPage": "Open Microsoft sign-in",
    "microsoft.statusReady": "Configure a Client ID to start device code sign-in.",
    "microsoft.statusWaiting": "Waiting for authorization on the Microsoft page.",
    "microsoft.statusSlowDown": "Microsoft asked for slower checks, so polling was delayed.",
    "microsoft.statusComplete": "Microsoft account connected.",
    "microsoft.statusFailed": "Microsoft sign-in was not completed.",
